namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class TonemappingColorGradingEditor : Editor
    {
        ...
        private void SetLUTImportSettings(TextureImporter importer)
        {
            ...
            //importer.linearTexture = true; //舊版寫法
            importer.sRGBTexture = true;     //新版寫法
            //importer.textureFormat = TextureImporterFormat.RGB24;//把它關掉
            ...
            if (concreteTarget.lut.enabled && concreteTarget.lut.texture != null)
            {
                ...
                else
                {
                    ...
                    bool valid = importer.anisoLevel == 0
                        && importer.mipmapEnabled == false
                     // && importer.linearTexture == true //舊版
                        && importer.sRGBTexture == true ;  //新版
